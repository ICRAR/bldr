...
pkg_default="1.10.5"
pkg_variants=("1.10.5")
#pkg_variants=("1.6.5" "1.8.8" "1.10.5")
#pkg_variants=("1.10.5")
...
pkg_cfg+="--enable-mpi-fortran=all "
...
do
     ...
     pkg_urls="http://www.open-mpi.org/software/ompi/v1.10/downloads/$pkg_file"
